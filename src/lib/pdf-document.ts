...
import { buildPdfjsDocumentAssetOptions } from '@/lib/pdf-document-assets'
import { pdfjsLib } from '@/lib/pdf-worker'

export { pdfjsAssetBaseUrl, buildPdfjsDocumentAssetOptions } from '@/lib/pdf-document-assets'
