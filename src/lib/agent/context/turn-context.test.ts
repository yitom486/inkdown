...
describe('INKDOWN_STATIC_SKILL', () => {
  ...
  it('明确禁止 Agent 自行解析电子书，并区分纯文本走原生读', () => {
    ...
    expect(INKDOWN_STATIC_SKILL).toContain('inkdown_get_selection')
    expect(INKDOWN_STATIC_SKILL).not.toContain('inkdown_list_highlights')
    expect(INKDOWN_STATIC_SKILL).not.toContain('inkdown_get_viewport')
